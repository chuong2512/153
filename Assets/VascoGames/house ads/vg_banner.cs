...
//		instcanvas.SetActive(false);
	...
	IEnumerator makeclick()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbannerrec.php?clicked=1&spotid=" + spotid + "&adid=" + adid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
	...
	IEnumerator impressionok()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbannerrec.php?impressieok=1&spotid=" + spotid + "&adid=" + adid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
	}
	...
	public IEnumerator loadbanner(int start = 0)
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbannerrec.php?load=" + start + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
