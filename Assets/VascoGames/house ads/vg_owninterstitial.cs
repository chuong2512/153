...
public class vg_owninterstitial : MonoBehaviour {
	...
	IEnumerator makeclick()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslink + "/loadbannerown.php?clicked=1&spotid=" + spotid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
	...
	IEnumerator installcheck()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslink + "/loadbannerown.php?installcheck=1&spotid=" + spotid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
		closenow();
	}
	...
	IEnumerator impressionok()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslink + "/loadbannerown.php?impressieok=1&spotid=" + spotid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
	}
	...
	public IEnumerator loadbanner(int start = 0)
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslink + "/loadbannerown.php?load=" + start + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
