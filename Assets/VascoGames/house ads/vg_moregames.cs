...
//		instcanvas.SetActive(false);
	...
	IEnumerator makeclick()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbanner.php?clicked=1&spotid=" + spotid + "&adid=" + adid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
		print ("click " + blink);
	...
	IEnumerator impressionok()
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbanner.php?impressieok=1&spotid=" + spotid + "&adid=" + adid + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
	}
	...
	public IEnumerator loadbanner(int start = 0)
	{
		...
		WWW www = new WWW(vg_interstitial.houseadslinkbanner + "/loadbanner.php?load=" + start + "&bid=" + vg_interstitial.GBundleId + "&deviceid=" + SystemInfo.deviceUniqueIdentifier);
		yield return www;
